...
- **Google Gemini** (`gemini-3.5-flash-lite` โดยค่าเริ่มต้น) — รองรับทั้งข้อความและรูปภาพ
...
| `GEMINI_MODEL` | รุ่นหลัก ค่าเริ่มต้น `gemini-3.5-flash-lite` |
| `GEMINI_FALLBACK_MODEL` | รุ่นสำรองเมื่อรุ่นหลักโควตาหมด ค่าเริ่มต้น `gemini-3.5-flash` |
