...
— ปัจจุบันคือ **"น้องห้า"** ผู้ช่วย AI ที่แทนตัวเองว่า "น้องห้า" ลงท้าย "ค่ะ" โทน
อบอุ่นสุภาพ ตอบสั้น 1-3 ประโยคเหมือนคนคุยแชท ใช้อีโมจิไม่เกิน 1 ตัว ถามทีละคำถาม
และไม่แสร้งเป็นมนุษย์ (ถ้าถูกถามตรง ๆ จะยอมรับว่าเป็น AI) เปลี่ยนชื่อ/สรรพนามได้ที่
จุดเดียวนี้แล้วมีผลทั้งระบบ
